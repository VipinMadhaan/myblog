...
当下 Hugo 使用已被弃用的 [oEmbed-legacy](https://developers.facebook.com/docs/instagram/oembed-legacy) 链接 API 端点. 这些被弃用的 API 会导致 Hugo 在获取数据时发生错误. 最新的 API 已经被包括在了 [extended shortcode](https://feelit.VipinMadhaan.dev/theme-documentation-extended-shortcodes/#122-oembed-instagram) 里.
...
随着 [extended shortcode documentation](https://feelit.VipinMadhaan.dev/theme-documentation-extended-shortcodes/#123-oembed-twitter) 里最新 API 的发布, 该方法已经被移除.
