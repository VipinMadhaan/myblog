...
Welcome to take the time to propose a translation by [:(fa-solid fa-code-branch fa-fw): making a PR](https://github.com/dillonzq/LoveIt/pulls) to the theme!
{{< /admonition >}}
...
This method was moved with the newest API in the [extended shortcode documentation](https://feelit.VipinMadhaan.dev/theme-documentation-extended-shortcodes/#123-oembed-twitter).
